...
$(package)_config_opts+=no-fuzz-libfuzzer
$(package)_config_opts+=no-fuzz-afl
$(package)_config_opts+=no-external-tests
...
define $(package)_config_cmds
  RC="$(host)-windres" ./Configure $($(package)_config_opts)
endef
